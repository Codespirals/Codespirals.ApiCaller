...
namespace Codespirals.Solutions.ApiCaller
{
    ...
    {
        internal static IDisposable? BeginLoggingApiCall(this ILogger<ApiCallerService> logger, string? httpMethod, string? endpoint)
        {
        ...
        internal static void LogApiRequest(this ILogger<ApiCallerService> logger, HttpRequestMessage request)
        ...
        internal static void LogApiResponse(this ILogger<ApiCallerService> logger, HttpResponseMessage response)
        {
        ...
        internal static void LogApiResponseHeaders(this ILogger<ApiCallerService> logger, HttpResponseMessage response)
        {
        ...
        internal static void LogApiSuccess(this ILogger<ApiCallerService> logger)
            => logger.LogStep(LoggingExtensions.State.Success, "Api Call sucessfully completed.");
        internal static void LogApiFail(this ILogger<ApiCallerService> logger, string? error = null)
            => logger.LogStep(LoggingExtensions.State.Cancelled, $"Api Call failed: {error ?? "No error message"}");
        internal static void LogApiException(this ILogger<ApiCallerService> logger, Exception e)
